...
load([data_path 'all_Ts_rural_urbn_daytime'])
...
Diff_TRM = (Diff_Ts.*mask_combined - Ts_sum_TRM.*mask_combined).^2;
...
x = reshape(Diff_Ts.*mask_combined,[nrow*ncol*N,1]);
y = reshape(Ts_sum_TRM.*mask_combined,[nrow*ncol*N,1]);
...
set(gca, 'YTick', limit_down:2:limit_up);
...
% Diff_Ts; Ts_sum_TRM;
% Ts_term_alpha_TRM; Ts_term_ra_TRM; Ts_term_rs_TRM; Ts_term_Grnd_TRM

% dTs_dalpha_TRM_ref; dTs_dalpha_TRM_sel; dTs_dalpha_TRM
% dTs_dra_TRM_ref; dTs_dra_TRM_sel; dTs_dra_TRM
% dTs_drs_TRM_ref; dTs_drs_TRM_sel; dTs_drs_TRM
...
for i = 1:6
    ...
    if i == 1
        Values_input = Diff_Ts;
    elseif i == 2
        Values_input = Ts_sum_TRM;
    elseif i == 3
        Values_input = Ts_term_alpha_TRM;
    elseif i == 4
        Values_input = Ts_term_ra_TRM;
    elseif i == 5
        Values_input = Ts_term_rs_TRM;
    elseif i == 6
        Values_input = Ts_term_Grnd_TRM;
    end
...
print('-djpeg', '-r600', [data_path 'figure_combined_Ts.jpg'])
...
%%
variable_all = {'Diff_Ts','Ts_sum_TRM','Ts_term_alpha_TRM','Ts_term_ra_TRM','Ts_term_rs_TRM','Ts_term_Grnd_TRM'};
...
for ivar = 1:var_Num
    ...
    x_temp1 = nanmean(Diff_Ts(lon_index{region_index},lat_index{region_index},:).*mask_to_use(lon_index{region_index},lat_index{region_index},:),3);
...
for region_index = 3:3

% superbar(1+0.1125*(region_index-3)*2,Diff_Ts_mean{region_index},'E',Diff_Ts_std{region_index},'BarWidth',BarWidth_value,'ErrorbarLineWidth',ErrorbarLineWidth_value,'BarFaceColor',color(region_index,:),'ErrorbarColor','k','ErrorbarRelativeWidth', ErrorbarRelativeWidth_value)
% hold on
% box on

superbar(1+0.1125*(region_index-3)*2,Ts_sum_TRM_mean{region_index},'E',Ts_sum_TRM_std{region_index},'BarWidth',BarWidth_value,'ErrorbarLineWidth',ErrorbarLineWidth_value,'BarFaceColor',color(region_index,:),'ErrorbarColor','k','ErrorbarRelativeWidth', ErrorbarRelativeWidth_value)
hold on
box on
superbar(2+0.1125*(region_index-3)*2,Ts_term_alpha_TRM_mean{region_index},'E',Ts_term_alpha_TRM_std{region_index},'BarWidth',BarWidth_value,'ErrorbarLineWidth',ErrorbarLineWidth_value,'BarFaceColor',color(region_index,:),'ErrorbarColor','k','ErrorbarRelativeWidth', ErrorbarRelativeWidth_value)

superbar(3+0.1125*(region_index-3)*2,Ts_term_ra_TRM_mean{region_index},'E',Ts_term_ra_TRM_std{region_index},'BarWidth',BarWidth_value,'ErrorbarLineWidth',ErrorbarLineWidth_value,'BarFaceColor',color(region_index,:),'ErrorbarColor','k','ErrorbarRelativeWidth', ErrorbarRelativeWidth_value)

superbar(4+0.1125*(region_index-3)*2,Ts_term_rs_TRM_mean{region_index},'E',Ts_term_rs_TRM_std{region_index},'BarWidth',BarWidth_value,'ErrorbarLineWidth',ErrorbarLineWidth_value,'BarFaceColor',color(region_index,:),'ErrorbarColor','k','ErrorbarRelativeWidth', ErrorbarRelativeWidth_value)

superbar(5+0.1125*(region_index-3)*2,Ts_term_Grnd_TRM_mean{region_index},'E',Ts_term_Grnd_TRM_std{region_index},'BarWidth',BarWidth_value,'ErrorbarLineWidth',ErrorbarLineWidth_value,'BarFaceColor',color(region_index,:),'ErrorbarColor','k','ErrorbarRelativeWidth', ErrorbarRelativeWidth_value)
...
xlim([0.5 5.5])
set(gca, 'XTick', 1:5);
set(gca, 'XTickLabel', {'\DeltaT','\alpha','r_a','r_s','G'});
ylabel('^oC', 'fontname',Fontname_value,'Fontsize',Fontsize_value);
set(gca, 'fontname',Fontname_value,'Fontsize',Fontsize_value)
...
superbar(2+0.1125*(region_index-3)*2,Ts_sum_TRM_mean{region_index},'E',Ts_sum_TRM_std{region_index},'BarWidth',BarWidth_value,'ErrorbarLineWidth',ErrorbarLineWidth_value,'BarFaceColor',color(region_index,:),'ErrorbarColor','k','ErrorbarRelativeWidth', ErrorbarRelativeWidth_value)

superbar(3+0.1125*(region_index-3)*2,Ts_term_alpha_TRM_mean{region_index},'E',Ts_term_alpha_TRM_std{region_index},'BarWidth',BarWidth_value,'ErrorbarLineWidth',ErrorbarLineWidth_value,'BarFaceColor',color(region_index,:),'ErrorbarColor','k','ErrorbarRelativeWidth', ErrorbarRelativeWidth_value)

superbar(4+0.1125*(region_index-3)*2,Ts_term_ra_TRM_mean{region_index},'E',Ts_term_ra_TRM_std{region_index},'BarWidth',BarWidth_value,'ErrorbarLineWidth',ErrorbarLineWidth_value,'BarFaceColor',color(region_index,:),'ErrorbarColor','k','ErrorbarRelativeWidth', ErrorbarRelativeWidth_value)

superbar(5+0.1125*(region_index-3)*2,Ts_term_rs_TRM_mean{region_index},'E',Ts_term_rs_TRM_std{region_index},'BarWidth',BarWidth_value,'ErrorbarLineWidth',ErrorbarLineWidth_value,'BarFaceColor',color(region_index,:),'ErrorbarColor','k','ErrorbarRelativeWidth', ErrorbarRelativeWidth_value)

superbar(6+0.1125*(region_index-3)*2,Ts_term_Grnd_TRM_mean{region_index},'E',Ts_term_Grnd_TRM_std{region_index},'BarWidth',BarWidth_value,'ErrorbarLineWidth',ErrorbarLineWidth_value,'BarFaceColor',color(region_index,:),'ErrorbarColor','k','ErrorbarRelativeWidth', ErrorbarRelativeWidth_value)
...
ylabel('\Delta Ts (^oC)', 'fontname',Fontname_value,'Fontsize',Fontsize_value);
set(gca, 'fontname',Fontname_value,'Fontsize',Fontsize_value)
print('-djpeg', '-r600', [data_path 'figure_attribution_Ts.jpg'])
...
for region_index = 1:region_Num
    ...
    y_temp   = nanmean(Diff_Ts(lon_index{region_index},lat_index{region_index},:).*mask_to_use(lon_index{region_index},lat_index{region_index},:),3);
    y_temp2  = nanmean(Ts_sum_TRM(lon_index{region_index},lat_index{region_index},:).*mask_to_use(lon_index{region_index},lat_index{region_index},:),3);
...
print('-djpeg', '-r600', [data_path 'figure_scatter_Ts.jpg'])
...
print('-djpeg', '-r600', [data_path 'figure_covariance_Ts.jpg'])
