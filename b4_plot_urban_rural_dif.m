...
load([data_path 'all_Ts_rural_urbn_clear_nighttime'])
...
if do_global_pattern == 1  
    ...
    for ivar = 1:var_Num
        ...
        % save
        filename = ['figure_nighttime_summer_' variable];
        ...
        filename = ['figure_latitudinal_dependence_nighttime_summer_' variable];
        set(gcf, 'PaperPositionMode', 'manual');
        set(gcf, 'PaperUnits', 'points');
    ...
    for i = [1 3 5 7]
        ...
        a1 = imread([figure_path 'figure_nighttime_summer_' variable_all{i} '.jpg']);
        b1 = imread([figure_path 'figure_latitudinal_dependence_nighttime_summer_' variable_all{i} '.jpg']);
        c1 = [a1 b1];
        
        a2 = imread([figure_path 'figure_nighttime_summer_' variable_all{i+1} '.jpg']);
        b2 = imread([figure_path 'figure_latitudinal_dependence_nighttime_summer_' variable_all{i+1} '.jpg']);
        c2 = [a2 b2];
        
        c = [c1, c2];
        %             imshow(c)
        %             print('-djpeg', '-r600', [figure_path 'figure_combined_clear_nighttime_summer_all' num2str(i) '.jpg'])
        
        figure_combined = cat(1, figure_combined, c);
        
    end
    imshow(figure_combined)
    print('-djpeg', '-r600', [figure_path 'figure_dif_clear_nighttime_summer_all.jpg'])
    ...
    for ivar = 1:var_Num
        ...
        plot_map(Values_input, mask_urban, average_period_value, value_limit, yr_Num)
        % save
        filename = ['figure_nighttime_winter_' variable];
        set(gcf, 'PaperPositionMode', 'manual');
        set(gcf, 'PaperUnits', 'points');
        set(gcf, 'PaperPosition', [100, 100, 650, 310]);
        print('-djpeg', '-r600', [figure_path filename])
        ...
        x_limit = [-1 1]*value_limit;
        plot_latitudinal_dependence(Values_input, mask_urban, average_period_value, lat, x_limit, yr_Num)
        filename = ['figure_latitudinal_dependence_nighttime_winter_' variable];
        set(gcf, 'PaperPositionMode', 'manual');
        set(gcf, 'PaperUnits', 'points');
        set(gcf, 'PaperPosition', [100, 1000, 200, 310]);
        print('-djpeg', '-r600', [figure_path filename])
    ...
    for i = [1 3 5 7]
        ...
        a1 = imread([figure_path 'figure_nighttime_winter_' variable_all{i} '.jpg']);
        b1 = imread([figure_path 'figure_latitudinal_dependence_nighttime_winter_' variable_all{i} '.jpg']);
        c1 = [a1 b1];
        
        a2 = imread([figure_path 'figure_nighttime_winter_' variable_all{i+1} '.jpg']);
        b2 = imread([figure_path 'figure_latitudinal_dependence_nighttime_winter_' variable_all{i+1} '.jpg']);
        c2 = [a2 b2];
        
        c = [c1, c2];
        %             imshow(c)
        %             print('-djpeg', '-r600', [figure_path 'figure_combined_clear_nighttime_winter_all' num2str(i) '.jpg'])
        
        figure_combined = cat(1, figure_combined, c);
        
    end
    imshow(figure_combined)
    print('-djpeg', '-r600', [figure_path 'figure_dif_clear_nighttime_winter_all.jpg']) 
