...
function [Diff_T2,mask,m_TRM_sel_opt_T2,...
...
if (use_previously_optimized_m == 1)
    ...
    if isfile([data_path 'm_TRM_sel_opt_T2.mat'])
        load([data_path 'm_TRM_sel_opt_T2.mat'])
    else
        disp(['no m_TRM_sel_opt_T2.mat exits, please change use_previously_optimized_m to 0'])
    end
    ...
    if (do_optimize == 1)
        ...
        save ([data_path 'm_TRM_sel_opt_T2'], 'm_TRM_sel_opt_T2')
