...
dqs_dTa_TRM_ref  = BB.*dTs_dTa_TRM_ref;
dqs_dqa_TRM_ref  = BB.*dTs_dqa_TRM_ref - ra_ref./(ra_ref+rs_ref) + 1;

% sensitivity of surface specific humidity to emissivity
dqs_demis_TRM_ref = BB.*dTs_demis_TRM_ref;
...
% sensitivity of surface specific humidity to air temperature and specific humidity
dqs_dTa_TRM_sel  = BB.*dTs_dTa_TRM_sel;
dqs_dqa_TRM_sel  = BB.*dTs_dqa_TRM_sel - ra_sel./(ra_sel+rs_sel) + 1;

% sensitivity of surface specific humidity to emissivity
dqs_demis_TRM_sel = BB.*dTs_demis_TRM_sel;
