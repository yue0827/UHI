function display_map(values_input_average, value_limit)

values_get = values_input_average;
...
box on 
set(gca, 'Position', [0.1, 0.1, 0.74, 0.86])
set(gca, 'LineWidth', 0.3)
hold on 

% axis equal
lon1 = -180; lon2 = 180; lat1 = -90; lat2 = 90;
set(gca,'XLim',[lon1 lon2],'YLim',[-60 lat2]);
...
for i = 1:length(Color_value)-1
    out_mat(values>=Color_value(i) & values<Color_value(i+1)) = i;
end
